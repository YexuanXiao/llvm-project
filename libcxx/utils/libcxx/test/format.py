    ...
    def execute(self, test, litConfig):
        ...
        # suffixes above too.
            ...
            if "enable-benchmarks=run" in test.config.available_features:
                steps += ["%dbg(EXECUTED AS) %{exec} %t.exe --benchmark_min_time=%{benchmark_min_time} --benchmark_out=%{temp}/benchmark-result.json --benchmark_out_format=json > %{temp}/benchmark-result.txt"]
